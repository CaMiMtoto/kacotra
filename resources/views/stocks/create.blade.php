                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control form-control-solid @error('stock_name') is-invalid @enderror" id="stock_name" name="stock_name" type="text" placeholder="" value="{{ old('stock_name') }}" autocomplete="off"/>
                            @error('stock_name')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
