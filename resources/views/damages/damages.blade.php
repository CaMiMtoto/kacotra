    ...
    <div class="container-xl px-4">
        <div class="page-header-content pt-4">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-auto my-4">
                    <a href="{{ route('damages.getDamageReport') }}" class="btn btn-success add-list my-1"><i class="fa-solid fa-file-export me-3"></i>Export</a>
                    <a href="{{ route('damages.createDamage') }}" class="btn btn-primary add-list my-1"><i class="fa-solid fa-plus me-3"></i>Add</a>
                    <a href="{{ route('damages.allDamages') }}" class="btn btn-danger add-list my-1"><i class="fa-solid fa-trash me-3"></i>Clear Search</a>
                </div>
            </div>
            ...
            <nav class="mt-4 rounded" aria-label="breadcrumb">
                <ol class="breadcrumb px-3 py-2 rounded mb-0">
                    ...
                    <li class="breadcrumb-item active">All Damages</li>
                </ol>
            </nav>
        </div>
    </div>
                        ...
                        <table class="table table-striped align-middle">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col">@sortablelink('damage_date', 'Date')</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @if ($damage->damage_status == 1)
                                        <td>
                                            <span class="btn btn-success btn-sm text-uppercase">approved</span>
                                        </td>
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('damages.damageDetails', $damage->id) }}" class="btn btn-outline-success btn-sm mx-1"><i class="fa-solid fa-eye"></i></a>
                                            </div>
                                        </td>
                                    @else
                                        <td>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('damages.damageDetails', $damage->id) }}" class="btn btn-outline-success btn-sm mx-1"><i class="fa-solid fa-eye"></i></a>
                                                <form action="{{ route('damages.deleteDamage', $damage->id) }}" method="POST">
                                                    @csrf
                                                    @method('delete')
