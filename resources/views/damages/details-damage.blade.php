            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row gx-3 mb-3">
                        <!-- Form Group (damage date) -->
                        <div class="col-md-6">
                            <label class="small mb-1">Damage Date</label>
                            <div class="form-control form-control-solid">{{ $damage->damage_date }}</div>
                        </div>
                    </div>
                    <!-- Form Row -->
                    <div class="row gx-3 mb-3">
                        ...
                        <div class="col-md-6">
                            <label class="small mb-1">No Damage</label>
                            <div class="form-control form-control-solid">{{ $damage->damage_no }}</div>
                        </div>
                        <!-- Form Group (paid amount) -->
                        <div class="col-md-6">
                            <label class="small mb-1">Total</label>
                            <div class="form-control form-control-solid">{{ $damage->total_amount }}</div>
                        </div>
                    </div>
                    <!-- Form Row -->
                    <div class="row gx-3 mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-control form-control-solid">{{ $damage->user_created->name }}</div>
                        </div>
                        <!-- Form Group (paid amount) -->
                        <div class="col-md-6">
                            <label class="small mb-1">Updated By</label>
                            <div class="form-control form-control-solid">{{ $damage->user_updated ? $damage->user_updated->name : '-' }}</div>
                        </div>
                    </div>

                    @if ($damage->damage_status == 0)
                    <form action="{{ route('damages.updateDamage') }}" method="POST">
                        @csrf
                        @method('put')
                        <input type="hidden" name="id" value="{{ $damage->id }}">
                        <!-- Submit button -->
                        <button type="submit" class="btn btn-success" onclick="return confirm('Are you sure you want to approve this damage?')">Approve Damage</button>
