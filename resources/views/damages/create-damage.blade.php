        ...
        <div class="page-header-content pt-4">
            ...
            <nav class="mt-4 rounded" aria-label="breadcrumb">
                <ol class="breadcrumb px-3 py-2 rounded mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('products.index') }}">Damages</a></li>
...
<div class="container-xl px-2 mt-n10">
    <form action="{{ route('damages.storeDamage') }}" method="POST">
        @csrf
        <div class="row">
            <div class="col-xl-12">
                <!-- BEGIN: Damage Details -->
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row gx-3 mb-3">
                            <!-- Form Group (date) -->
                            <div class="col-md-6">
                                <label class="small my-1" for="damage_date">Date <span class="text-danger">*</span></label>
                                <input class="form-control form-control-solid example-date-input @error('damage_date') is-invalid @enderror" name="damage_date" id="date" type="date" value="{{ old('damage_date') }}" required>
                                @error('damage_date')
                            ...
                            <table class="table align-middle">
                                ...
                                <tbody>
                                    <tr class="table-primary">
                                        ...
                                        <td>
                                            <button type="submit" class="btn btn-outline-success" onclick="return confirm('Are you sure you want to damage?')">
                                                Damage Store
                                            </button>
                                        </td>
                                    </tr>
