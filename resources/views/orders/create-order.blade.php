        ...
        <div class="page-header-content pt-4">
            ...
            <nav class="mt-4 rounded" aria-label="breadcrumb">
                <ol class="breadcrumb px-3 py-2 rounded mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('products.index') }}">Orders</a></li>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row gx-3 mb-3">
                            <!-- Form Group (date) -->
                            <div class="col-md-6">
                                <label class="small my-1" for="order_date">Date <span class="text-danger">*</span></label>
                                <input class="form-control form-control-solid example-date-input @error('order_date') is-invalid @enderror" name="order_date" id="date" type="date" value="{{ old('order_date') }}" required>
                                @error('order_date')
                            ...
                            <!-- Form Group (customer) -->
                            <div class="col-md-6">
                                <label class="small my-1" for="customer_id">Customer <span class="text-danger">*</span></label>
                            ...
                            <table class="table align-middle">
                                ...
                                <tbody>
                                    <tr class="table-primary">
                                        ...
                                        <td>
                                            <button type="submit" class="btn btn-outline-success" onclick="return confirm('Are you sure you want to order?')">
                                                Order Store
                                            </button>
                                        </td>
                                    </tr>
...
<script id="document-template" type="text/x-handlebars-template">
    <tr class="delete_add_more_item" id="delete_add_more_item">
        ...
        <td>
            <input type="number" step="any" min="1" class="form-control input-sm quantity" name="quantity[]" value="" required>
        </td>

        <td>
            <input type="number" step="any" class="form-control input-sm unitcost" name="unitcost[]" value="" required>
        </td>

        <td>
            <input type="number" step="any" class="form-control input-sm total" name="total[]" value="0" readonly>
        </td>
