            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row gx-3 mb-3">
                        ...
                        <div class="col-md-6">
                            <label class="small mb-1">Refund Amount</label>
                    ...
                    <!-- Submit button -->
                    <button class="btn btn-success" type="button" data-bs-toggle="modal" data-bs-target="#modal">Pay Refund</button>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title text-center mx-auto" id="modalCenterTitle">Invoice of {{ $order->customer->name }}<br/>Total Amount <b>{{ number_format($order->total) }} RwF</b></h3>
            </div>

            <form action="{{ route('order.updateRefundOrder') }}" method="POST">
                @csrf
                @method('put')
                <div class="modal-body">
                    <div class="modal-body">
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <!-- Form Group (due amount) -->
                            <div class="col-md-6">
                                <label class="small mb-1">Refund</label>
                                <div class="form-control form-control-solid">{{ $order->due }}</div>
                            </div>
                        </div>
                        <!-- Form Row -->
                        <div class="row gx-3 mb-3">
                            <!-- Form Group (pay now) -->
                            <div class="col-md-6">
                                <label class="small mb-1" for="pay">Pay Back Now <span class="text-danger">*</span></label>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-lg btn-success" type="submit">Pay Back</button>
                </div>
            </form>
        </div>
    </div>
