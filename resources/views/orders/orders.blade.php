        ...
        <div class="container-xl px-4">
            <div class="page-header-content pt-4">
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-auto my-4">
                        <a href="{{ route('orders.getOrderReport') }}" class="btn btn-success add-list my-1"><i
                                class="fa-solid fa-file-export me-3"></i>Export</a>
                        <a href="{{ route('orders.createOrder') }}" class="btn btn-primary add-list my-1"><i
                                class="fa-solid fa-plus me-3"></i>Add</a>
                        <a href="{{ route('orders.allOrders') }}" class="btn btn-danger add-list my-1"><i
                                ...
                                <table class="table table-sm table-striped align-middle">
                                    ...
                                    @foreach ($orders as $order)
                                        <tr>
                                            ...
                                            <td>{{ optional($order->customer)->name??$order->customer??'N/A' }}</td>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    @elseif ($order->order_status == 'complete' && $order->due < 0)
                                                        <a href="{{ route('order.refundOrderDetails', $order->id) }}"
                                                    ...
                                                    @else
                                                        <a href="{{ route('order.orderCompleteDetails', $order->id) }}"
