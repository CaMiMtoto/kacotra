                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select form-control-solid @error('type') is-invalid @enderror" id="type" name="type">
                                    ...
                                    <option value="Banking" @if(old('type') == 'Banking')selected="selected"@endif>Banking</option>
                                </select>
                                @error('type')
                                <div class="invalid-feedback">
                                    {{ $message }}
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select form-control-solid @error('bank_name') is-invalid @enderror" id="bank_name" name="bank_name">
                                    ...
                                    <option value="BK" @if(old('bank_name') == 'BK')selected="selected"@endif>Bank of Kigali</option>
                                    <option value="BPR" @if(old('bank_name') == 'BPR')selected="selected"@endif>BPR</option>
                                    ...
                                    <option value="ACCESS" @if(old('bank_name') == 'ACCESS')selected="selected"@endif>ACCESS</option>
                                </select>
                                @error('bank_name')
                                <div class="invalid-feedback">
                                    {{ $message }}
