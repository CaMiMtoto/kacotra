                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <a href="{{ route('product.deleteProduct', $product->id) }}" class="btn btn-outline-danger btn-sm" onclick="return confirm('Are you sure you want to delete this record?')"><i class="far fa-trash-alt"></i></a>
                                            @endif
                                        </div>
                                    </td>
                                </tr>
