        ...
        <div class="col-xl-6">
            ...
            <div class="card mb-4 mb-xl-0">
                ...
                <div class="card-body">
                                ...
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <select class="form-control" name="row">
                                            ...
                                            <option value="500" @if(request('row') == '500')selected="selected"@endif>500</option>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="table-responsive">
                            <div class="overflow-auto" style="min-height:200px;max-height:300px">
                                <table class="table table-dark table-sm table-striped align-middle">
                                    <thead class="thead-light">
                                        <tr>
                                            <th scope="col">No.</th>
                                            <th scope="col">@sortablelink('product_name', 'Product')</th>
                                                ...
                                                <div class="d-flex">
                                                    <form action="{{ route('pos.addCartItem', $product->id) }}" method="POST">
                                                        ...
                                                        <div class="input-group input-group-sm">
                                                            ...
                                                            <input type="number" class="form-control input-sm" name="price" step="any" value="{{ $product->selling_price }}" required>
                                                            <div class="input-group-append">
                                                        ...
                                                        {{-- <input type="hidden" name="id" value="{{ $product->id }}">
                                                        <input type="hidden" name="name" value="{{ $product->product_name }}">
                                                        <input type="number" name="price" value="{{ $product->selling_price }}" required>
