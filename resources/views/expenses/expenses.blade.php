    ...
    <div class="container-xl px-4">
        <div class="page-header-content pt-4">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-auto my-4">
                    <a href="{{ route('expenses.getExpenseReport') }}" class="btn btn-success add-list my-1"><i class="fa-solid fa-file-export me-3"></i>Export</a>
                    <a href="{{ route('expenses.createExpense') }}" class="btn btn-primary add-list my-1"><i class="fa-solid fa-plus me-3"></i>Add</a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @if ($expense->expense_status == 1)
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('expenses.expenseDetails', $expense->id) }}" class="btn btn-outline-success btn-sm mx-1"><i class="fa-solid fa-eye"></i></a>
                                                @if (auth()->user()->role == 'admin')
                                                    <a href="{{ route('expenses.deleteExpense', $expense->id) }}" class="btn btn-outline-danger btn-sm" onclick="return confirm('Are you sure you want to delete this record?')"><i class="far fa-trash-alt"></i></a>
                                                @endif
                                            </div>
                                        </td>
                                    @else
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('expenses.expenseDetails', $expense->id) }}" class="btn btn-outline-success btn-sm mx-1"><i class="fa-solid fa-eye"></i></a>
                                                {{-- <form action="{{ route('expenses.deleteExpense', $expense->id) }}" method="POST">
                                                    @csrf
                                                    @method('delete')
