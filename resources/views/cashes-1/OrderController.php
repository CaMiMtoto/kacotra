...
class OrderController extends Controller
{
    ...
    */
    public function dailyCashReport()
    {
        ...
        $deposits = DB::table('deposits')
            ...
            -> select(
                'methods.name as dep_method',
                'banks.name as dep_name',
                'deposits.transaction_id as dep_transaction',
                'deposits.account_no as dep_account',
        ...
        $total = $total_paid - $subTotal3 - $subTotal4 + $subTotal6 - $total_refund;
    ...
    */
    public function currentWeekCashReport()
    {
        ...
        $total = $subTotal1 - $subTotal3 - $subTotal4 + $subTotal6 - $subTotal7;
    ...
    */
    ...
    public function filterCashReport(Request $request)
    {
        ...
        $total = $total_paid + $total_refund - $subTotal3 - $subTotal4 + $subTotal6 - $subTotal7;
    ...
    */
    public function exportOrderReport(Request $request)
    {
        ...
        $orders = DB::table('order_details')
            ...
            ->whereBetween('orders.order_date',[$sDate,$eDate])
            ->where('orders.order_status','1')
            ->select( 'orders.invoice_no', 'orders.order_date', 'orders.customer_id','products.product_code',
            'products.product_name', 'order_details.quantity', 'order_details.unitcost', 'order_details.total')
            ->get();
    ...
    */
    public function deleteOrder(String $order_id)
    {
        ...
        return Redirect::route('order.allOrders')->with('success', 'Order has been deleted!');
    }
