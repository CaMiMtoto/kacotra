        ...
        <div class="page-header-content pt-4">
            ...
            <nav class="mt-4 rounded" aria-label="breadcrumb">
                <ol class="breadcrumb px-3 py-2 rounded mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('departments.index') }}">Categories</a></li>
            ...
            <div class="col-xl-12">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <!-- Form Group (name) -->
                        <div class="mb-3">
                            <label class="small mb-1" for="name">Department Name <span class="text-danger">*</span></label>
                        ...
                        <!-- Form Group (slug) -->
                        <div class="mb-3">
                            <label class="small mb-1" for="slug">Department Slug (non editable).</label>
