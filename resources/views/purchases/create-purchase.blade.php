                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <!-- Form Group (supplier) -->
                                <div class="col-md-6">
                                    <label class="small my-1" for="supplier">Supplier <span class="text-danger">*</span></label>
                                    <input class="form-control form-control-solid  @error('supplier') is-invalid @enderror" name="supplier" id="supplier" type="text" value="{{ old('supplier') }}" required>
                                    @error('supplier')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
        ...
        document.addEventListener('change', function(e) {
            if (e.target && e.target.id === 'category_id') {
                ...
                fetch(`{{ route('get-all-product') }}?category_id=${category_id}`)
                    ...
                    .then(data => {
                        let html = '<option disabled selected>Select a product:</option>'; // default option
