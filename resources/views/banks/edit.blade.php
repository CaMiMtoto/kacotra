...
<div class="container-xl px-2 mt-n10">
    <form action="{{ route('banks.update', $category->slug) }}" method="POST">
        @csrf
        @method('put')
        <div class="row">
            ...
            <div class="col-xl-12">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <!-- Form Group (name) -->
                        <div class="mb-3">
                            <label class="small mb-1" for="name">Bank Name <span class="text-danger">*</span></label>
                        ...
                        <!-- Form Group (slug) -->
                        <div class="mb-3">
                            <label class="small mb-1" for="slug">Bank Slug (non editable).</label>
                        ...
                        <a class="btn btn-danger" href="{{ route('banks.index') }}">Cancel</a>
                    </div>
                </div>
                <!-- END: Bank Details -->
            </div>
